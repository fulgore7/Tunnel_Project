...
Public Class WcfTsaLocalFactoryProvider
    Inherits ProviderBase(Of WcfTsaLocalFactoryProvider)
    ...
    Public ReadOnly Property Rail As IWcfTsaRailInfoServiceClient Implements IWcfTsaFactoryProvider.Rail
        Get
            Return New WcfTsaLocalRailInfoServiceClient(WcfBindingType.Tcp)
        End Get
    End Property

    Public ReadOnly Property Team As IWcfTsaTeamServiceClient Implements IWcfTsaFactoryProvider.Team
        Get
            Return New WcfTsaLocalTeamServiceClient(WcfBindingType.Tcp)
        End Get
    End Property
End Class